...
class CosmicJustice:
# s CosmicJustice !file::CosmicJustice
    def __init__(self):
    # f __init__() !void
    # p self file::CosmicJustice
        self.balance = 0.0
        # v balance float
...
def goat_generator1():
# f goat_generator1() !file::CosmicGoat
    return CosmicGoat(10, 20, 30.5)
    # U{ simple_id file::CosmicGoat }

def goat_generator2():
# f goat_generator2() !file::CosmicGoat
...
# f goat_generator() (file::CosmicGoat,file::CosmicGoat)
