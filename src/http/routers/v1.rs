...
use crate::http::routers::v1::at_tools::{handle_v1_tools, handle_v1_tools_authorize_calls};
...
pub fn make_v1_router() -> Router {
    Router::new()
        ...
        .route("/tools-authorize-calls", telemetry_post!(handle_v1_tools_authorize_calls))
