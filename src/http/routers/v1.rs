...
use crate::http::routers::v1::ast::{handle_v1_ast_cursor_search, handle_v1_ast_query_search, handle_v1_ast_references};
...
pub fn make_v1_router() -> Router {
    Router::new()
        ...
        .route("/ast-references", telemetry_post!(handle_v1_ast_references))
}
