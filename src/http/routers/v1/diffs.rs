...
pub async fn handle_v1_diff_apply(
    ...
    let (_results, outputs) = read_files_n_apply_diff_chunks(load_privacy_if_needed(global_context.clone()).await, &post.chunks, &applied_state, &desired_state, MAX_FUZZY_N);
