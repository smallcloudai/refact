  ...
  return (
    <Flex direction="column" gap="2" maxWidth="540px" m="8px">
      <TourBox style={{ gap: "15px", alignSelf: "center" }}>
        ...
        >
          {
            'The workflow to learn first: select a few lines in your code, hit F1, ask model to change it. When you are happy with the result, paste it back into the editor using the "Show" button. You will see a diff between your selection and the code generated by the model, so it\'s easy to see if those are the changes you want.'
          }
        </Text>
