...
use crate::http::routers::v1::workspace::{handle_v1_get_active_group_candidates, handle_v1_set_active_group_id};
...
pub fn make_v1_router() -> Router {
    let builder = Router::new()
        ...
        .route("/get-active-group-candidates", get(handle_v1_get_active_group_candidates))
