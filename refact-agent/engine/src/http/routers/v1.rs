...
use crate::http::routers::v1::at_tools::{
    handle_v1_tools, handle_v1_tools_check_if_confirmation_needed, handle_v1_tools_execute,
};
...
#[cfg(feature = "vecdb")]
use crate::http::routers::v1::handlers_memdb::{
    handle_mem_add, handle_mem_erase, handle_mem_update_used, handle_mem_block_until_vectorized,
};
...
use crate::agent_db::db_chore::{
    handle_db_v1_chore_update, handle_db_v1_chore_event_update, handle_db_v1_chores_sub,
};
...
pub fn make_v1_router() -> Router {
    ...
    let builder = builder
        ...
        .route(
            "/mem-block-until-vectorized",
            get(handle_mem_block_until_vectorized),
        )
