...
use crate::http::routers::v1::mcp::{handle_mcp_servers, handle_mcp_resources, handle_mcp_resource_content};
...
pub fn make_v1_router() -> Router {
    let builder = Router::new()
        ...
        .route("/mcp-resource-content", get(handle_mcp_resource_content))
