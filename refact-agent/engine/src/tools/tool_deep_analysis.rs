...
async fn _make_prompt(
    ...
    let tokenizer = cached_tokenizers::cached_tokenizer(caps, gcx.clone(), subchat_params.subchat_model.to_string(), subchat_params.subchat_provider.to_string()).await
