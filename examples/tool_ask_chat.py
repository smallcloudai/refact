...
default_system = ["system", "You are a coding assistant. Use your sense of humor"]
tool_use_system = ["system", "You are a coding assistant. Use your sense of humor. Before answering, use tool calls to fetch definitions of all the types and functions. Your first answer must consist of tool calls."]
...
def ask_chat(msgs, tool_use, endpoint: str = "http://127.0.0.1:8001/v1/chat/completions"):
    if tool_use:
        msgs = [tool_use_system, *msgs]
    else:
        msgs = [default_system, *msgs]
...
def ask():
    ...
    print(messages[-1][1])
    r2 = ask_chat(messages, False, "http://127.0.0.1:8001/v1/chat")
    print(r2)
